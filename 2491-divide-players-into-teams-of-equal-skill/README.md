...
<pre style="position: relative;"><strong>Input:</strong> skill = [3,2,5,1,3,4]
...
<pre style="position: relative;"><strong>Input:</strong> skill = [3,4]
...
<pre style="position: relative;"><strong>Input:</strong> skill = [1,1,2,3]
