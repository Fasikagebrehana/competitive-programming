...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,0,1,0]
...
Note the answer [4,2] would also be accepted.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
