<h2><a href="https://leetcode.com/problems/check-if-number-is-a-sum-of-powers-of-three/">1780. Check if Number is a Sum of Powers of Three</a></h2><h3>Medium</h3><hr><div><p>Given an integer <code>n</code>, return <code>true</code> <em>if it is possible to represent </em><code>n</code><em> as the sum of distinct powers of three.</em> Otherwise, return <code>false</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> n = 91
<strong>Output:</strong> true
...
<pre style="position: relative;"><strong>Input:</strong> n = 21
