...
<pre style="position: relative;"><strong>Input:</strong> tasks = [[1,2],[2,4],[4,8]]
...
Notice that even though we have leftover energy, starting with 7 energy does not work because we cannot do the 3rd task.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> tasks = [[1,3],[2,4],[10,11],[10,12],[8,9]]
...
Starting with 32 energy, we finish the tasks in the following order:
    ...
    - 5th task. Now energy = 9 - 8 = 1.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> tasks = [[1,7],[2,8],[3,9],[4,10],[5,11],[6,12]]
