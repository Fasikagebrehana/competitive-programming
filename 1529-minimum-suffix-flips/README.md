...
<pre style="position: relative;"><strong>Input:</strong> target = "10111"
...
<pre style="position: relative;"><strong>Input:</strong> target = "101"
<strong>Output:</strong> 3
...
<pre style="position: relative;"><strong>Input:</strong> target = "00000"
