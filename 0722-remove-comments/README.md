...
<pre style="position: relative;"><strong>Input:</strong> source = ["/*Test program */", "int main()", "{ ", "  // variable declaration ", "int a, b, c;", "/* This is a test", "   multiline  ", "   comment for ", "   testing */", "a = b + c;", "}"]
...
<pre style="position: relative;"><strong>Input:</strong> source = ["a/*comment", "line", "more_comment*/b"]
