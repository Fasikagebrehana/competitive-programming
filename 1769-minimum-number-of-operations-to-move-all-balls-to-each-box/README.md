...
<pre style="position: relative;"><strong>Input:</strong> boxes = "110"
...
<pre style="position: relative;"><strong>Input:</strong> boxes = "001011"
<strong>Output:</strong> [11,8,5,4,3,4]<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
